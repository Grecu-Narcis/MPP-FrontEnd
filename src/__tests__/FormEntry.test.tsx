...
test('test form entry without default value', () => {
    ...
    render(<FormEntry label='test-label' placeHolder='test-placeHolder' disabled={false} defaultValue='' ref={demoReference} />);
...
test('test form entry with default value', () => {
    ...
    render(<FormEntry label='test-label' placeHolder='test-placeHolder' disabled={false} defaultValue='test value' ref={demoReference} />);
...
test('test form entry for disabled input', () => {
    ...
    render(<FormEntry label='test-label' placeHolder='test-placeHolder' disabled={true} defaultValue='test value' ref={demoReference} />);
